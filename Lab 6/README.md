...
We created an emergency alert system for IOT devices, such as smart displays, so that in an emergency, all connected devices can provide information to the user, rather than relying on someone monitoring their email or seeing a phone notification. This would be useful so there are fewer chances to miss an emergency notification, causing one to act sooner and potentially avoid a dangerous situation.  

**\*\*\*2. Diagram the architecture of the system.\*\*\*** Be clear to document where input, output and computation occur, and label all parts and connections. For example, where is the banana, who is the banana player, where does the sound get played, and who is listening to the banana music?  

The input can come from multiple sources, depending on the type of alert. A severe weather alert or regional/national safety alert would be generated by the government and relayed accordingly. Building security alerts, such as fire or intrusion, would be generated by building security or the fire system. The alert could be generated from a client machine or pulled from an emergency alerts server, depending on the type. All individuals who interact or see IOT devices would be potential users, as in an emergency, these devices (primarily those with displays) would provide information.  

**\*\*\*3. Build a working prototype of the system.\*\*\*** Do think about the user interface: if someone encountered these bananas somewhere in the wild, would they know how to interact with them? Should they know what to expect?  

Since the interaction does not require input from the user, it would be simple to understand how it occurs. A display image would pop up in an emergency and provide simple directions and graphics. For those who send messages, preset emergency situations can be created to speed up the sending process.  

**\*\*\*4. Document the working prototype in use.\*\*\*** It may be helpful to record a Zoom session where you should the input in one location clearly causing response in another location.  

[Video](https://drive.google.com/file/d/1kPyC2LMp4_tcGdU-NTrKR6FbGm7aUfTl/view?usp=sharing)
